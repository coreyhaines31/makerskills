---
name: adapt-skill
description: When you want to port an external skill (from GitHub, agentskills.io, or anywhere public) into one of your sibling skill repos and adapt it to your voice, tooling, and conventions. Examples already done informally — riffing on garrytan/gstack for naming, frontend-slides for the slide-deck workflow, last30days for deep-research, llm-wiki for second-brain. Three-bucket analysis (keep verbatim / adapt / add), tool-swap pass (their video tool → your watch-video, their kanban → your pm, etc.), voice pass, attribution file, license check (MIT/Apache green; GPL warn; proprietary stop). Triggers on "/adapt-skill <url>," "adapt this skill," "port this skill," "fork this skill," "borrow this skill," "let's adapt X for our repo," "make our own version of this." Sibling to create-skill — that one creates from chat/dump/scratch; this one adapts from an external source.
metadata:
  version: 0.1.0
---
